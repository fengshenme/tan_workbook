...
const routes = [
      {path:'/' , redirect:'/home',},
      // 配置路由规则的
      {path:'/home' , redirect:'/home/index', name:'HomeContainer', 
      component: () => import('@/components/tabbar/HomeContainer.vue') , // 当路由为空时，会重定向到/home
        children: [
    ...
    { 
      path: '/user', redirect: '/user/userinfo',name: 'MemberContainer', 
