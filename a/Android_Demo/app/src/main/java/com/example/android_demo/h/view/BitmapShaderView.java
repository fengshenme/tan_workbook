...
public class BitmapShaderView<Bitmap> extends View {


    private android.graphics.Bitmap mBitmap = null;
    ...
    private void init() {
        ...
        //创建BitmapShader
        mBitmapShader = new BitmapShader((android.graphics.Bitmap) mBitmap, Shader.TileMode.MIRROR, Shader.TileMode.MIRROR);
