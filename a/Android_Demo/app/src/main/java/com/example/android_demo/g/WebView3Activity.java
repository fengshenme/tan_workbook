...
public class WebView3Activity extends AppCompatActivity {
    ...
    class MyWebChromeClient extends WebChromeClient {
        ...
        public boolean onJsAlert(WebView view, String url, String message,
            ...
            new Builder(WebView3Activity.this).setTitle("Alert对话框").setMessage(message)
        ...
        public boolean onJsConfirm(WebView view, String url, String message,
                                   final JsResult result) {
            new Builder(WebView3Activity.this).setTitle("Confirm对话框").setMessage(message)
                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
        ...
        public boolean onJsPrompt(WebView view, String url, String message,
            ...
            final LayoutInflater inflater = LayoutInflater.from(WebView3Activity.this);
            ...
            //定义对话框上的确定按钮
            new Builder(WebView3Activity.this).setTitle("Prompt对话框").setView(myview)
                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            //单机确定后取得输入的值,传给网页处理
