...
public class DrawerLayoutActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new MyAdapter<Item>(menuLists,R.layout.item_list_a) {
            @Override
            public void bindView(ViewHolder holder, Item obj) {
                holder.setImageResource(R.id.img_icon0,obj.getIconId());
                holder.setText(R.id.txt_content0, obj.getIconName());
            }
        };
