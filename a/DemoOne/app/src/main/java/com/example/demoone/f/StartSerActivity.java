...
import com.example.demoone.f.service.TestService2;
...
public class StartSerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent.setAction("com.example.demoone.f.service.TEST_SERVICE1");
        ...
        intent1.setAction("com.example.demoone.f.service.TEST_SERVICE2");
