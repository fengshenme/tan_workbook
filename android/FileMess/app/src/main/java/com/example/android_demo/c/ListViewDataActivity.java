...
import com.example.android_demo.c.entity.Data;
import com.example.android_demo.c.entity.MyAdapter;

import java.util.LinkedList;
import java.util.List;

public class ListViewDataActivity extends AppCompatActivity implements Button.OnClickListener {

    private ListView list_one;
    private MyAdapter<Data> mAdapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = ListViewDataActivity.this;
        bindViews();
