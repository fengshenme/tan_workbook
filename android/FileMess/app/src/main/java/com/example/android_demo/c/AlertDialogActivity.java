...
public class AlertDialogActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btn_dialog_one,btn_dialog_two,btn_dialog_three,btn_dialog_four;
    ...
    public void onClick(View v) {
        alert = null;
        builder = new AlertDialog.Builder(mContext).setIcon(R.mipmap.ic_icon_fish);
        switch (v.getId()) {
            //普通对话框
            ...
            case R.id.btn_dialog_three:
                ...
                alert = builder.setTitle("选择你喜欢的水果，只能选一个哦~")
