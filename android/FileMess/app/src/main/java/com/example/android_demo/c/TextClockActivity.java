...
public class TextClockActivity extends AppCompatActivity implements View.OnClickListener,Chronometer.OnChronometerTickListener{
    ...
    public void onChronometerTick(Chronometer chronometer) {
        ...
        if(time.equals("00:00")){
            Toast.makeText(TextClockActivity.this,"时间到了~",Toast.LENGTH_SHORT).show();
        }
    }
