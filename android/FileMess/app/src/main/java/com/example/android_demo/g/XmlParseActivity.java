...
import com.example.android_demo.g.utils.DomHelper;
import com.example.android_demo.g.utils.Person;
import com.example.android_demo.g.utils.PullHelper;
import com.example.android_demo.g.utils.SaxHelper;
...
public class XmlParseActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btnsax:
                    ...
                    mAdapter = new ArrayAdapter<Person>(XmlParseActivity.this,
                ...
                case R.id.btndom:
                    ...
                    mAdapter = new ArrayAdapter<Person>(XmlParseActivity.this, android.R.layout.simple_expandable_list_item_1, persons);
                    list.setAdapter(mAdapter);
                    break;
