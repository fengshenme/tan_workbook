...
int main(int argc, char const *argv[])
{
    ...
    //关闭摄像头采集
    // enum v4l2_buf_type ftype;
    // ftype = V4L2_BUF_TYPE_VIDEO_CAPTURE;
...
int show(unsigned int (*FB)[W], unsigned int *argbbuf)
{

    // 2.操作显存，显示颜色
    // unsigned int color_red = 0x00FF0000;
    int num = 0, i, j;
    printf("[%d] --- %#x \n", __LINE__, argbbuf[100]);
