...
在Lambda表达式内可以访问当前作用域的变量，这是Lambda表达式的闭包（Closure）行为。 与JavaScript闭包不同，
...
void lambdac(){
    ...
    auto add_x = [x,y](int a) mutable { x *= 2; return a + x + y; };  // 复制捕捉x
    cout << add_x(10) << endl; // 输出 
...
// 局部变量声明
   ...
   cout << "交换前，a 的值：" << a1 << endl;
   cout << "交换前，b 的值：" << b1 << endl;
 
   // 调用函数来交换值
   swap(a1, b1);
 
   cout << "交换后，a 的值：" << a1 << endl;
   cout << "交换后，b 的值：" << b1 << endl;
...
void swap(int a, int b)
{
   ...
   int temp;
   temp = a; /* 保存 x 的值 */
   cout << "交换后------b 的值：" << temp << endl;
   a = b;    /* 把 y 赋值给 x */
   cout << "交换后------b 的值：" << a << endl;
   b = temp; /* 把 x 赋值给 y */
...
void pointerva(){
   ...
   cout << "pointerva交换前，a 的值：" << a << endl;
   cout << "pointerva交换前，b 的值：" << b << endl;
   ...
   cout << "pointerva交换后，a 的值：" << a << endl;
   cout << "pointerva交换后，b 的值：" << b << endl;
