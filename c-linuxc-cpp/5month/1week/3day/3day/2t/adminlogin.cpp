...
void AdminLogin::log_check(bool flag)
{
    if (flag) {
...
QString AdminLogin::load_status()
{
...
bool AdminLogin::save_status(QString strstat)
{
...
void AdminLogin::show_head(QByteArray msg)
{
...
// 跳转注册界面
void AdminLogin::on_registB_clicked()
{
...
void AdminLogin::on_usele_textEdited(const QString& arg1)
{
    qDebug() << arg1;
...
void AdminLogin::on_usele_editingFinished()
{
    QString name = ui->usele->text();
