...
//    playlist = new QMediaPlaylist;
    ...
    playlist->addMedia(QUrl("H:/sharecode/yueqian/video/11.mp4"));
    playlist->addMedia(QUrl("H:/sharecode/yueqian/video/12.mp4"));
    playlist->addMedia(QUrl("H:/sharecode/yueqian/video/13.mp4"));
